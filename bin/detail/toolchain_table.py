...
if platform.system() == 'Darwin':
  toolchain_table += [
      ...
      Toolchain('ios-nocodesign-10-3-dep-8-0-bitcode', 'Xcode', ios_version='10.3', nocodesign=True),
      Toolchain('ios-nocodesign-10-3-dep-9-0-bitcode', 'Xcode', ios_version='10.3', nocodesign=True),
      Toolchain('ios-nocodesign-11-0-dep-8-0-bitcode', 'Xcode', ios_version='11.0', nocodesign=True),
